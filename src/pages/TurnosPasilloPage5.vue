...
const columns = ref([
{
  ...
  
  {
    ...
    field: "posicion",
    align:"right",
    style: "font-size: 107px; font-weight: bold; width: 70%; padding: 0px;",
...
const rows = ref([
  {
    ...
    posiciones: ['52','53','54','55','56','57','58'] ,
  },
  {
    marca:  `src/img/marcas/norma.png`,
    posiciones: ['12','13','14','15','16','17','18'] ,
  },
  {
    marca:  `src/img/marcas/scribe.png`,
    posiciones: ['22','23','24','25','26','27','28'] ,
  },
  {
    marca:  `src/img/marcas/smart.png`,
    posiciones: ['42','43','44','45','46','47','48'] ,
    
  },
  {
    marca:  `src/img/marcas/newell.png`,

    posiciones: ['32','33','34','35','36','37','38'] ,
